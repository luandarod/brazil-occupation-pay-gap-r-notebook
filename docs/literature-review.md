...
The notebook does not stop at "top salaries". It checks medians, uncertainty and composition. It also avoids turning regression residuals into a discrimination claim.

The strongest literature link is occupational segregation. People are not randomly spread across occupations, and occupations are not uniform inside. That is why the project separates three questions: who is in the occupation, what the income distribution looks like, and what associations remain after basic controls.
